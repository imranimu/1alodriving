    ...
    public function course_payment_validation(Request $request)
    {
        ...
        try {
            ...
            Session::put('getCourse', [
                ...
                'address2' =>  Auth::user() != "" ? Auth::user()->address2 : $request->address2,
                'city_town' =>  Auth::user() != "" ? Auth::user()->city_town : $request->city_town,
                'postcode' =>  Auth::user() != "" ? Auth::user()->postcode : $request->postcode,
    ...
    public function stripe_card_payment(Request $request)
    {
        ...
        if (blank(Auth::user())) {
            $arr = [
                ...
                'address2' => $getCourse['address2'],
                'city_town' => $getCourse['city_town'],
                'postcode' => $getCourse['postcode'],
