        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Student Lists</h4>
                </div><!-- end card header -->
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-2">
                            <form action="{{ url('admin/student-show') }}" method="get">
                                        ...
                                        <tr>
                                            ...
                                            @if (File::exists('storage/image/student/thumbnail/' . $val->image))
                                                <td><img id="avatar" alt="admin-banner-image-{{ $count }}"
                                                        src="{{ asset('storage/image/student/thumbnail/' . $val->image) }}" />
                                                </td>
                                            @else
                                                <td> no image</td>
                                            @endif
                                            ...
                                            <td>
                                                <a class="badge bg-info"
                                                    href="{{ url('admin/student/' . $val->id . '/edit') }}">
                                                    <i class="ri-edit-2-line"></i>
                                                </a>

                                                <a class="badge bg-primary"
                                                    href="{{ url('admin/user/' . $val->id . '/password') }}"
